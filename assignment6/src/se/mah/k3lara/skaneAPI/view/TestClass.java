...
public class TestClass {
	...
	public static void main(String[] args) {
		//Takes getURl for the class Constants and sets Malmö as start destination and Lund as end, and number of searchresults to 20
		...
		//"calls" Skånetrafikken URL to get a list of available journeys 
	   ...
	   System.out.println("// Stations when searching for stations containing \"Malm\"");
		//  creates a list in which to add stations
	   ArrayList<Station> searchStations = new ArrayList<Station>(); 
		// adds stations from SkånetrafikkenURL and searches for stations with malm in it, adds it to the ArrayList searchStations. 
